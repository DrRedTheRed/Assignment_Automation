...
for i = 1:9
    ...
    P = curr_ply.Location; %Change the current frame into coordinate frame0.
    
    P = (T_total(1:3,1:3)*P'+T_total(1:3,4))';
    ...
    title(sprintf('ICP aligned accumulated image and ply_%d',i));
    saveas(fig, fullfile(output_folder, sprintf('ICP_Aligned_ply_accumulated_image_and_ply_%d.png',i-1,i)));
